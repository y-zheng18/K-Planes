    ...
    def __init__(self,
        ...
        if dset_type == "fluid":
            ...
            if split == "render":
                ...
                img_h, img_w = imgs[0].shape[:2]
                self.per_cam_near_fars = torch.tensor([[3.5, 5.25]])
